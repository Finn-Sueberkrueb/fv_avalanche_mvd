...
class OffboardControl(Node):
    ...
    def __init__(self) -> None:
        ...
        # used to visulize in RVIZ
        self.drone_position_publisher = self.create_publisher(PoseStamped, '/fv/drone_position', 10)
        ...
        self.next_search_position_subscriber = self.create_subscription(
            Int16, '/fv/search_length', self.search_length_callback, 10)
    ...
    def vehicle_local_position_callback(self, vehicle_local_position):
        ...
        position_px4 = np.array([vehicle_local_position.x, vehicle_local_position.y, vehicle_local_position.z])        
    ...
    def next_search_position_callback(self, next_search_position):
        ...
        self.next_search_position = np.array([next_search_position.pose.position.x, next_search_position.pose.position.y, next_search_position.pose.position.z])
